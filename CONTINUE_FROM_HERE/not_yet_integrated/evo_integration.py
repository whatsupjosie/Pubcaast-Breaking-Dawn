...
class EVOOrchestrator:
    ...
    def __init__(self, active_character: str = "pete"):
    ...
    async def start(
        ...
        Call this after both the engine node and camera manager are initialized.
        """
        self._engine_node    = engine_node
        self._camera_manager = camera_manager
        self._running        = True
        logger.info("[EVO] Orchestrator started")
